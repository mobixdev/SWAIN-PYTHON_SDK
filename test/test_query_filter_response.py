...
class TestQueryFilterResponse(unittest.TestCase):
    """QueryFilterResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryFilterResponse:
        """Test QueryFilterResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryFilterResponse`
        """
        model = QueryFilterResponse()
        if include_optional:
    ...
    def testQueryFilterResponse(self):
        """Test QueryFilterResponse"""
