...
class TestQuerySortSpec(unittest.TestCase):
    """QuerySortSpec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuerySortSpec:
        """Test QuerySortSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuerySortSpec`
        """
        model = QuerySortSpec()
        if include_optional:
