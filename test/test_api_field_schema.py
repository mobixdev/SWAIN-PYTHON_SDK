...
class TestApiFieldSchema(unittest.TestCase):
    """ApiFieldSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiFieldSchema:
        """Test ApiFieldSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiFieldSchema`
        """
        model = ApiFieldSchema()
        if include_optional:
