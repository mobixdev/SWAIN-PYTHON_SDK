...
class TestApiFilterPayload(unittest.TestCase):
    """ApiFilterPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiFilterPayload:
        """Test ApiFilterPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiFilterPayload`
        """
        model = ApiFilterPayload()
        if include_optional:
            return ApiFilterPayload(
                expressions = [
                    None
                    ]
            )
