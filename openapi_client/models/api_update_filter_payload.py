...
class ApiUpdateFilterPayload(BaseModel):
    """
    ApiUpdateFilterPayload
    """ # noqa: E501
    expressions: Optional[List[Dict[str, Any]]] = None
    update_data: Optional[Dict[str, Any]] = Field(default=None, alias="updateData")
    __properties: ClassVar[List[str]] = ["expressions", "updateData"]
