...
class ApiModelsResponse(BaseModel):
    ...
    """ # noqa: E501
    models: Optional[Dict[str, StrictStr]] = Field(default=None, description="Models is a map of model names to their corresponding table names example: {\"User\": \"users\", \"Post\": \"posts\"}")
