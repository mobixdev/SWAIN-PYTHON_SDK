...
class QuerySortSpec(BaseModel):
    ...
    """ # noqa: E501
    direction: Optional[StrictStr] = Field(default=None, description="@Description The sort direction: \"asc\" for ascending, \"desc\" for descending @Description Case-insensitive, so \"ASC\", \"asc\", and \"Asc\" are all valid")
    var_field: Optional[StrictStr] = Field(default=None, description="@Description The name of the field to sort by @Description Can be a struct field name (e.g., \"FirstName\"), JSON field name (from json tag), @Description or database column name (e.g., \"first_name\")", alias="field")
