...
class SchemaApi:
    ...
    def model_schema_get(
        ...
        _param = self._model_schema_get_serialize(
            model=model,
    ...
    @validate_call
    def model_schema_get_with_http_info(
        self,
        model: Annotated[StrictStr, Field(description="Model name")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def model_schema_get_without_preload_content(
        self,
        model: Annotated[StrictStr, Field(description="Model name")],
        _request_timeout: Union[
            None,
    ...
    def _model_schema_get_serialize(
        self,
        model,
        _request_auth,
        _content_type,
